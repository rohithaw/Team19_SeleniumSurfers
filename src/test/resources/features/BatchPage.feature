...
@tag1
  Scenario: Validate header,data table header, footer, pagination, and default state of delete button in the Batch Page
   Then Admin should see 'Manage Batch' in the header and the total number of records in the footer in the Batch Page
 ...
 @tag2   
  ...
  And Admin attempts to enter "<Batch Name>", "<Description>", "<Status>", "<No of Classes>", and "<Program Name>" in the popup and clicks "save"
