...
public class BatchPage extends DriverFactory{
 ...
 //locators for the error message field 
	...
	By noofclasseserror=By.xpath("//body/app-root[1]/app-batch[1]/p-dialog[1]/div[1]/div[1]/div[2]/small[1]");
	//locators batchpopupvalidation
	   ...
	   /* private void programdropdown() {
		...
		public void Save() {
		  ...
		  /* public void editBatchDetails(String batchName, String batchDescription) {
		   ...
		   public void editBatch(String batchName, String description, int classes, String program) {
		   ...
		   public void clearMandatoryField() {
		        WebElement batchNameField = driver.findElement(batchname);
		        batchNameField.clear();
		        //clickSave();
		        System.out.println("batch nameField Error: " +  namefielderror());
		    }
